...
func (_m *MockQuerier) ClaimIdempotencyKey(ctx context.Context, arg ClaimIdempotencyKeyParams) (models.DatabaseULID, error) {
	ret := _m.Called(ctx, arg)
	...
	var r0 models.DatabaseULID
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ClaimIdempotencyKeyParams) (models.DatabaseULID, error)); ok {
		return rf(ctx, arg)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ClaimIdempotencyKeyParams) models.DatabaseULID); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Get(0).(models.DatabaseULID)
	}
...
// DeleteExpiredIdempotencyKeys provides a mock function with given fields: ctx, createdAt
func (_m *MockQuerier) DeleteExpiredIdempotencyKeys(ctx context.Context, createdAt time.Time) (int64, error) {
	ret := _m.Called(ctx, createdAt)

	if len(ret) == 0 {
		panic("no return value specified for DeleteExpiredIdempotencyKeys")
	}
...
func (_m *MockQuerier) PlayerCategoryForEvent(ctx context.Context, arg PlayerCategoryForEventParams) (models.ScoringCategory, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, PlayerCategoryForEventParams) (models.ScoringCategory, error)); ok {
		return rf(ctx, arg)
	}
	if rf, ok := ret.Get(0).(func(context.Context, PlayerCategoryForEventParams) models.ScoringCategory); ok {
		r0 = rf(ctx, arg)
	} else {
		r0 = ret.Get(0).(models.ScoringCategory)
	}

	if rf, ok := ret.Get(1).(func(context.Context, PlayerCategoryForEventParams) error); ok {
		r1 = rf(ctx, arg)
	} else {
		r1 = ret.Error(1)
	}
