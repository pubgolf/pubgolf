...
<p>
	This privacy notice for Eric Morris (<strong>"Company"</strong>, <strong>"we"</strong>,
	<strong>"us"</strong>, or <strong>"our"</strong>), describes how and why we might collect, store,
	use, and/or share (<strong>"process"</strong>) your information when you use our services (<strong
		>"Services"</strong
	>), such as when you:
</p>
...
<ul>
	<li>
		Visit our website at <a href="https://pubgolf.co">https://pubgolf.co</a>, or any website of ours
		that links to this privacy notice
	</li>
	<li>
		Download and use our mobile application (PubGolf), or any other application of ours that links
...
<p>
	...
	If you still have any questions or concerns, please contact us at pubgolf+contact@thedeerchild.com.
</p>
...
<p>
	...
	Services, we may process personal information depending on how you interact with Eric Morris and
...
<p>
	...
	may share information in specific situations and with specific third parties. Learn more about
...
<p>
	Want to learn more about what Eric Morris does with any information we collect? <a href="#toc"
...
<p id="personalinfo">Personal information you disclose to us</p>
...
<p id="sensitiveinfo">Sensitive Information. We do not process sensitive information.</p>
...
<p>
	...
	pubgolf+legal@thedeerchild.com.
</p>
		...
		<tbody>
			...
			<tr>
				...
				<td
					...
					title, work history, and professional qualifications if you apply for a job with us</td
				>
				<td>No</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td
					...
					profile or summary about, for example, an individual’s preferences and characteristics</td
				>
				<td>No</td>
			</tr>
			<tr>
...
<p>
	You may contact us by email at pubgolf+legal@thedeerchild.com, or by referring to the contact
...
<p>
	Eric Morris has not disclosed, sold, or shared any personal information to third parties for a
	business or commercial purpose in the preceding twelve (12) months. Eric Morris will not sell or
...
<h5>Right to Limit Use and Disclosure of Sensitive Personal Information</h5>
...
<p>
	To exercise these rights, you can contact us by email at pubgolf+legal@thedeerchild.com, or by
...
<p>
	...
	with Eric Morris and our Services. To find out more, please visit the following links:
</p>
...
<p>
	Eric Morris has not sold any personal data to third parties for business or commercial purposes.
	Eric Morris will not sell personal data in the future belonging to website visitors, users, and
	other consumers.
</p>
...
<p>You may contact us by email at pubgolf+legal@thedeerchild.com.</p>
...
<p>
	...
	pubgolf+legal@thedeerchild.com. Within sixty (60) days of receipt of an appeal, we will inform you
	in writing of any action taken or not taken in response to the appeal, including a written
	explanation of the reasons for the decisions. If your appeal if denied, you may contact the <a
...
<p>
	...
	we make material changes to this privacy notice, we may notify you either by prominently posting a
...
<p>
	...
	review, update, or delete your personal information, please email: pubgolf+legal@thedeerchild.com.
</p>
